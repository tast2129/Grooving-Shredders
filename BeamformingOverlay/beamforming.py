...
class BeamformingOverlay(pynq.Overlay):
    """Beamforming overlay for the board.

    This beamforming overlay contains Pmod 0 and 1, LEDs, RGBLEDs, push buttons,
    switches, pin control gpio, and beamforming weight gpio

    After reloading the beamforming overlay, the I2C and display port should become
    available as well.
