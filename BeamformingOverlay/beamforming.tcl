...
# module references:
# axis_multiplier, axis_multiplier, axis_multiplier, axis_multiplier, axis_multiplier, axis_multiplier, axis_multiplier, axis_multiplier
...
proc create_hier_cell_channel_21 { parentCell nameHier } {
  ...
  # Create pins
  create_bd_pin -dir I -from 7 -to 0 bWeight_imag_21
  create_bd_pin -dir I -from 7 -to 0 bWeight_real_21
  ...
  # Create instance: axis_multiplier_imag, and set properties
  set block_name axis_multiplier
  set block_cell_name axis_multiplier_imag
  if { [catch {set axis_multiplier_imag [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $axis_multiplier_imag eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: axis_multiplier_real, and set properties
  set block_name axis_multiplier
  set block_cell_name axis_multiplier_real
  if { [catch {set axis_multiplier_real [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $axis_multiplier_real eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  connect_bd_intf_net -intf_net axis_clock_converter_im_M_AXIS [get_bd_intf_pins axis_clock_converter_im/M_AXIS] [get_bd_intf_pins axis_multiplier_imag/s_axis]
  connect_bd_intf_net -intf_net axis_clock_converter_re_M_AXIS [get_bd_intf_pins axis_clock_converter_re/M_AXIS] [get_bd_intf_pins axis_multiplier_real/s_axis]
  connect_bd_intf_net -intf_net axis_multiplier_imag_m_axis_s2mm [get_bd_intf_pins axi_dma_imag/S_AXIS_S2MM] [get_bd_intf_pins axis_multiplier_imag/m_axis_s2mm]
  connect_bd_intf_net -intf_net axis_multiplier_real_m_axis_s2mm [get_bd_intf_pins axi_dma_real/S_AXIS_S2MM] [get_bd_intf_pins axis_multiplier_real/m_axis_s2mm]
  ...
  connect_bd_net -net bWeight_imag_21_1 [get_bd_pins bWeight_imag_21] [get_bd_pins axis_multiplier_imag/bWeight]
  connect_bd_net -net bWeight_real_21_1 [get_bd_pins bWeight_real_21] [get_bd_pins axis_multiplier_real/bWeight]
  connect_bd_net -net concat_irq_dout [get_bd_pins irq] [get_bd_pins concat_irq/dout]
  connect_bd_net -net proc_sys_reset_1_peripheral_aresetn [get_bd_pins m_axis_aresetn] [get_bd_pins axi_dma_imag/axi_resetn] [get_bd_pins axi_dma_real/axi_resetn] [get_bd_pins axi_interconnect_hpm/M00_ARESETN] [get_bd_pins axi_interconnect_hpm/M01_ARESETN] [get_bd_pins axi_interconnect_hps/ARESETN] [get_bd_pins axi_interconnect_hps/M00_ARESETN] [get_bd_pins axi_interconnect_hps/S00_ARESETN] [get_bd_pins axi_interconnect_hps/S01_ARESETN] [get_bd_pins axis_clock_converter_im/m_axis_aresetn] [get_bd_pins axis_clock_converter_re/m_axis_aresetn] [get_bd_pins axis_multiplier_imag/resetn] [get_bd_pins axis_multiplier_real/resetn]
...
proc create_hier_cell_channel_20 { parentCell nameHier } {
  ...
  # Create pins
  create_bd_pin -dir I -from 7 -to 0 bWeight_imag_20
  create_bd_pin -dir I -from 7 -to 0 bWeight_real_20
  create_bd_pin -dir O -from 1 -to 0 irq
  create_bd_pin -dir I -type clk m_axis_aclk
  create_bd_pin -dir I -type rst m_axis_aresetn
  create_bd_pin -dir I -type clk s_axi_aclk
  ...
  connect_bd_net -net axi_dma_imag_s2mm_introut [get_bd_pins axi_dma_imag/s2mm_introut] [get_bd_pins concat_irq/In1]
  connect_bd_net -net axi_dma_real_s2mm_introut [get_bd_pins axi_dma_real/s2mm_introut] [get_bd_pins concat_irq/In0]
  connect_bd_net -net bWeight_imag_20_1 [get_bd_pins bWeight_imag_20] [get_bd_pins axis_multiplier_imag/bWeight]
  connect_bd_net -net bWeight_real_20_1 [get_bd_pins bWeight_real_20] [get_bd_pins axis_multiplier_real/bWeight]
  connect_bd_net -net concat_irq_dout [get_bd_pins irq] [get_bd_pins concat_irq/dout]
  connect_bd_net -net proc_sys_reset_1_peripheral_aresetn [get_bd_pins m_axis_aresetn] [get_bd_pins axi_dma_imag/axi_resetn] [get_bd_pins axi_dma_real/axi_resetn] [get_bd_pins axi_interconnect_hpm/M00_ARESETN] [get_bd_pins axi_interconnect_hpm/M01_ARESETN] [get_bd_pins axi_interconnect_hps/ARESETN] [get_bd_pins axi_interconnect_hps/M00_ARESETN] [get_bd_pins axi_interconnect_hps/S00_ARESETN] [get_bd_pins axi_interconnect_hps/S01_ARESETN] [get_bd_pins axis_clock_converter_im/m_axis_aresetn] [get_bd_pins axis_clock_converter_re/m_axis_aresetn] [get_bd_pins axis_multiplier_imag/resetn] [get_bd_pins axis_multiplier_real/resetn]
  connect_bd_net -net proc_sys_reset_adc0_peripheral_aresetn [get_bd_pins s_axis_aresetn] [get_bd_pins axi_interconnect_hpm/M02_ARESETN] [get_bd_pins axis_clock_converter_im/s_axis_aresetn] [get_bd_pins axis_clock_converter_re/s_axis_aresetn] [get_bd_pins packet_generator/aresetn]
  connect_bd_net -net rfdc_clk_adc0 [get_bd_pins s_axis_aclk] [get_bd_pins axi_interconnect_hpm/M02_ACLK] [get_bd_pins axis_clock_converter_im/s_axis_aclk] [get_bd_pins axis_clock_converter_re/s_axis_aclk] [get_bd_pins packet_generator/aclk]
...
proc create_hier_cell_channel_01 { parentCell nameHier } {
  ...
  # Create pins
  create_bd_pin -dir I -from 7 -to 0 bWeight_imag_01
  create_bd_pin -dir I -from 7 -to 0 bWeight_real_01
  create_bd_pin -dir O -from 1 -to 0 irq
  create_bd_pin -dir I -type clk m_axis_aclk
  create_bd_pin -dir I -type rst m_axis_aresetn
  create_bd_pin -dir I -type clk s_axi_aclk
  ...
  connect_bd_net -net axi_dma_imag_s2mm_introut [get_bd_pins axi_dma_imag/s2mm_introut] [get_bd_pins concat_irq/In1]
  connect_bd_net -net axi_dma_real_s2mm_introut [get_bd_pins axi_dma_real/s2mm_introut] [get_bd_pins concat_irq/In0]
  connect_bd_net -net bWeight_imag_01_1 [get_bd_pins bWeight_imag_01] [get_bd_pins axis_multiplier_imag/bWeight]
  connect_bd_net -net bWeight_real_01_1 [get_bd_pins bWeight_real_01] [get_bd_pins axis_multiplier_real/bWeight]
  connect_bd_net -net concat_irq_dout [get_bd_pins irq] [get_bd_pins concat_irq/dout]
  connect_bd_net -net proc_sys_reset_1_peripheral_aresetn [get_bd_pins m_axis_aresetn] [get_bd_pins axi_dma_imag/axi_resetn] [get_bd_pins axi_dma_real/axi_resetn] [get_bd_pins axi_interconnect_hpm/M00_ARESETN] [get_bd_pins axi_interconnect_hpm/M01_ARESETN] [get_bd_pins axi_interconnect_hps/ARESETN] [get_bd_pins axi_interconnect_hps/M00_ARESETN] [get_bd_pins axi_interconnect_hps/S00_ARESETN] [get_bd_pins axi_interconnect_hps/S01_ARESETN] [get_bd_pins axis_clock_converter_im/m_axis_aresetn] [get_bd_pins axis_clock_converter_re/m_axis_aresetn] [get_bd_pins axis_multiplier_imag/resetn] [get_bd_pins axis_multiplier_real/resetn]
  connect_bd_net -net proc_sys_reset_adc0_peripheral_aresetn [get_bd_pins s_axis_aresetn] [get_bd_pins axi_interconnect_hpm/M02_ARESETN] [get_bd_pins axis_clock_converter_im/s_axis_aresetn] [get_bd_pins axis_clock_converter_re/s_axis_aresetn] [get_bd_pins packet_generator/aresetn]
  connect_bd_net -net rfdc_clk_adc0 [get_bd_pins s_axis_aclk] [get_bd_pins axi_interconnect_hpm/M02_ACLK] [get_bd_pins axis_clock_converter_im/s_axis_aclk] [get_bd_pins axis_clock_converter_re/s_axis_aclk] [get_bd_pins packet_generator/aclk]
...
proc create_hier_cell_channel_00 { parentCell nameHier } {
  ...
  # Create pins
  create_bd_pin -dir I -from 7 -to 0 bWeight_imag_00
  create_bd_pin -dir I -from 7 -to 0 bWeight_real_00
  create_bd_pin -dir O -from 1 -to 0 irq
  create_bd_pin -dir I -type clk m_axis_aclk
  create_bd_pin -dir I -type rst m_axis_aresetn
  create_bd_pin -dir I -type clk s_axi_aclk
  ...
  connect_bd_intf_net -intf_net axis_clock_converter_im_M_AXIS [get_bd_intf_pins axis_clock_converter_im/M_AXIS] [get_bd_intf_pins axis_multiplier_imag/s_axis]
  connect_bd_intf_net -intf_net axis_clock_converter_re_M_AXIS [get_bd_intf_pins axis_clock_converter_re/M_AXIS] [get_bd_intf_pins axis_multiplier_real/s_axis]
  connect_bd_intf_net -intf_net axis_multiplier_0_m_axis_s2mm [get_bd_intf_pins axi_dma_real/S_AXIS_S2MM] [get_bd_intf_pins axis_multiplier_real/m_axis_s2mm]
  connect_bd_intf_net -intf_net axis_multiplier_1_m_axis_s2mm [get_bd_intf_pins axi_dma_imag/S_AXIS_S2MM] [get_bd_intf_pins axis_multiplier_imag/m_axis_s2mm]
  connect_bd_intf_net -intf_net packet_generator_0_M_AXIS_IM [get_bd_intf_pins axis_clock_converter_im/S_AXIS] [get_bd_intf_pins packet_generator/M_AXIS_IM]
  connect_bd_intf_net -intf_net packet_generator_0_M_AXIS_RE [get_bd_intf_pins axis_clock_converter_re/S_AXIS] [get_bd_intf_pins packet_generator/M_AXIS_RE]
  ...
  connect_bd_net -net axi_dma_imag_s2mm_introut [get_bd_pins axi_dma_imag/s2mm_introut] [get_bd_pins concat_irq/In1]
  connect_bd_net -net axi_dma_real_s2mm_introut [get_bd_pins axi_dma_real/s2mm_introut] [get_bd_pins concat_irq/In0]
  connect_bd_net -net bWeight_imag_00_1 [get_bd_pins bWeight_imag_00] [get_bd_pins axis_multiplier_imag/bWeight]
  connect_bd_net -net bWeight_real_00_1 [get_bd_pins bWeight_real_00] [get_bd_pins axis_multiplier_real/bWeight]
  connect_bd_net -net concat_irq_dout [get_bd_pins irq] [get_bd_pins concat_irq/dout]
  connect_bd_net -net proc_sys_reset_1_peripheral_aresetn [get_bd_pins m_axis_aresetn] [get_bd_pins axi_dma_imag/axi_resetn] [get_bd_pins axi_dma_real/axi_resetn] [get_bd_pins axi_interconnect_hpm/M00_ARESETN] [get_bd_pins axi_interconnect_hpm/M01_ARESETN] [get_bd_pins axi_interconnect_hps/ARESETN] [get_bd_pins axi_interconnect_hps/M00_ARESETN] [get_bd_pins axi_interconnect_hps/S00_ARESETN] [get_bd_pins axi_interconnect_hps/S01_ARESETN] [get_bd_pins axis_clock_converter_im/m_axis_aresetn] [get_bd_pins axis_clock_converter_re/m_axis_aresetn] [get_bd_pins axis_multiplier_imag/resetn] [get_bd_pins axis_multiplier_real/resetn]
  connect_bd_net -net proc_sys_reset_adc0_peripheral_aresetn [get_bd_pins s_axis_aresetn] [get_bd_pins axi_interconnect_hpm/M02_ARESETN] [get_bd_pins axis_clock_converter_im/s_axis_aresetn] [get_bd_pins axis_clock_converter_re/s_axis_aresetn] [get_bd_pins packet_generator/aresetn]
  connect_bd_net -net rfdc_clk_adc0 [get_bd_pins s_axis_aclk] [get_bd_pins axi_interconnect_hpm/M02_ACLK] [get_bd_pins axis_clock_converter_im/s_axis_aclk] [get_bd_pins axis_clock_converter_re/s_axis_aclk] [get_bd_pins packet_generator/aclk]
...
proc create_hier_cell_receiver { parentCell nameHier } {
  ...
  # Create port connections
  connect_bd_net -net bWeight_imag_00_1 [get_bd_pins bWeight_imag_00] [get_bd_pins channel_00/bWeight_imag_00]
  connect_bd_net -net bWeight_imag_01_1 [get_bd_pins bWeight_imag_01] [get_bd_pins channel_01/bWeight_imag_01]
  connect_bd_net -net bWeight_imag_20_1 [get_bd_pins bWeight_imag_20] [get_bd_pins channel_20/bWeight_imag_20]
  connect_bd_net -net bWeight_imag_21_1 [get_bd_pins bWeight_imag_21] [get_bd_pins channel_21/bWeight_imag_21]
  connect_bd_net -net bWeight_real_00_1 [get_bd_pins bWeight_real_00] [get_bd_pins channel_00/bWeight_real_00]
  connect_bd_net -net bWeight_real_01_1 [get_bd_pins bWeight_real_01] [get_bd_pins channel_01/bWeight_real_01]
  connect_bd_net -net bWeight_real_20_1 [get_bd_pins bWeight_real_20] [get_bd_pins channel_20/bWeight_real_20]
  connect_bd_net -net bWeight_real_21_1 [get_bd_pins bWeight_real_21] [get_bd_pins channel_21/bWeight_real_21]
...
proc create_hier_cell_radio { parentCell nameHier } {
  ...
  # Create port connections
  connect_bd_net -net bWeight_imag_00_1 [get_bd_pins bWeight_imag_00] [get_bd_pins receiver/bWeight_imag_00]
  connect_bd_net -net bWeight_imag_01_1 [get_bd_pins bWeight_imag_01] [get_bd_pins receiver/bWeight_imag_01]
  connect_bd_net -net bWeight_imag_20_1 [get_bd_pins bWeight_imag_20] [get_bd_pins receiver/bWeight_imag_20]
  connect_bd_net -net bWeight_imag_21_1 [get_bd_pins bWeight_imag_21] [get_bd_pins receiver/bWeight_imag_21]
  connect_bd_net -net bWeight_real_00_1 [get_bd_pins bWeight_real_00] [get_bd_pins receiver/bWeight_real_00]
  connect_bd_net -net bWeight_real_01_1 [get_bd_pins bWeight_real_01] [get_bd_pins receiver/bWeight_real_01]
  connect_bd_net -net bWeight_real_20_1 [get_bd_pins bWeight_real_20] [get_bd_pins receiver/bWeight_real_20]
  connect_bd_net -net bWeight_real_21_1 [get_bd_pins bWeight_real_21] [get_bd_pins receiver/bWeight_real_21]
  ...
  connect_bd_net -net s_axi_aclk_1 [get_bd_pins s_axi_aclk] [get_bd_pins axi_interconnect_ps/ACLK] [get_bd_pins axi_interconnect_ps/M00_ACLK] [get_bd_pins axi_interconnect_ps/M01_ACLK] [get_bd_pins axi_interconnect_ps/M02_ACLK] [get_bd_pins axi_interconnect_ps/S00_ACLK] [get_bd_pins receiver/s_axi_aclk] [get_bd_pins rfdc/s_axi_aclk] [get_bd_pins transmitter/s_axi_aclk]
...
proc create_root_design { parentCell } {
  ...
  # Create instance: imag_bWeights, and set properties
  set imag_bWeights [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 imag_bWeights ]
  set_property -dict [ list \
   CONFIG.C_ALL_OUTPUTS {1} \
 ] $imag_bWeights
  ...
  # Create instance: real_bWeights, and set properties
  set real_bWeights [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 real_bWeights ]
  set_property -dict [ list \
   CONFIG.C_ALL_OUTPUTS {1} \
 ] $real_bWeights
  ...
  # Create instance: xlslice_imag_00, and set properties
  set xlslice_imag_00 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 xlslice_imag_00 ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {7} \
   CONFIG.DOUT_WIDTH {8} \
 ] $xlslice_imag_00

  # Create instance: xlslice_imag_01, and set properties
  set xlslice_imag_01 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 xlslice_imag_01 ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {15} \
   CONFIG.DIN_TO {8} \
   CONFIG.DOUT_WIDTH {8} \
  ...
  # Create instance: xlslice_imag_20, and set properties
  set xlslice_imag_20 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 xlslice_imag_20 ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {23} \
   CONFIG.DIN_TO {16} \
   CONFIG.DOUT_WIDTH {8} \
  ...
  # Create instance: xlslice_imag_21, and set properties
  set xlslice_imag_21 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 xlslice_imag_21 ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {31} \
   CONFIG.DIN_TO {24} \
   CONFIG.DOUT_WIDTH {8} \
  ...
  # Create instance: xlslice_real_00, and set properties
  set xlslice_real_00 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 xlslice_real_00 ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {7} \
   CONFIG.DIN_TO {0} \
   CONFIG.DOUT_WIDTH {8} \
  ...
  # Create instance: xlslice_real_01, and set properties
  set xlslice_real_01 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 xlslice_real_01 ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {15} \
   CONFIG.DIN_TO {8} \
   CONFIG.DOUT_WIDTH {8} \
  ...
  # Create instance: xlslice_real_20, and set properties
  set xlslice_real_20 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 xlslice_real_20 ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {23} \
   CONFIG.DIN_TO {16} \
   CONFIG.DOUT_WIDTH {8} \
  ...
  # Create instance: xlslice_real_21, and set properties
  set xlslice_real_21 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 xlslice_real_21 ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {31} \
   CONFIG.DIN_TO {24} \
   CONFIG.DOUT_WIDTH {8} \
...
Port;FD4A0000;FD4AFFFF;1|FPD;DPDMA;FD4C0000;FD4CFFFF;1|FPD;DDR_XMPU5_CFG;FD050000;FD05FFFF;1|FPD;DDR_XMPU4_CFG;FD040000;FD04FFFF;1|FPD;DDR_XMPU3_CFG;FD030000;FD03FFFF;1|FPD;DDR_XMPU2_CFG;FD020000;FD02FFFF;1|FPD;DDR_XMPU1_CFG;FD010000;FD01FFFF;1|FPD;DDR_XMPU0_CFG;FD000000;FD00FFFF;1|FPD;DDR_QOS_CTRL;FD090000;FD09FFFF;1|FPD;DDR_PHY;FD080000;FD08FFFF;1|DDR;DDR_LOW;0;7FFFFFFF;1|DDR;DDR_HIGH;800000000;97FFFFFFF;1|FPD;DDDR_CTRL;FD070000;FD070FFF;1|LPD;Coresight;FE800000;FEFFFFFF;1|LPD;CSU_DMA;FFC80000;FFC9FFFF;1|LPD;CSU;FFCA0000;FFCAFFFF;1|LPD;CRL_APB;FF5E0000;FF85FFFF;1|FPD;CRF_APB;FD1A0000;FD2DFFFF;1|FPD;CCI_REG;FD5E0000;FD5EFFFF;1|LPD;CAN1;FF070000;FF07FFFF;0|LPD;CAN0;FF060000;FF06FFFF;0|FPD;APU;FD5C0000;FD5CFFFF;1|LPD;APM_INTC_IOU;FFA20000;FFA2FFFF;1|LPD;APM_FPD_LPD;FFA30000;FFA3FFFF;1|FPD;APM_5;FD490000;FD49FFFF;1|FPD;APM_0;FD0B0000;FD0BFFFF;1|LPD;APM2;FFA10000;FFA1FFFF;1|LPD;APM1;FFA00000;FFA0FFFF;1|LPD;AMS;FFA50000;FFA5FFFF;1|FPD;AFI_5;FD3B0000;FD3BFFFF;1|FPD;AFI_4;FD3A0000;FD3AFFFF;1|FPD;AFI_3;FD390000;FD39FFFF;1|FPD;AFI_2;FD380000;FD38FFFF;1|FPD;AFI_1;FD370000;FD37FFFF;1|FPD;AFI_0;FD360000;FD36FFFF;1|LPD;AFIFM6;FF9B0000;FF9BFFFF;1|FPD;ACPU_GIC;F9010000;F907FFFF;1} \
  ...
  connect_bd_intf_net -intf_net axi_hpm0_fpd_M02_AXI [get_bd_intf_pins axi_hpm0_fpd/M02_AXI] [get_bd_intf_pins imag_bWeights/S_AXI]
  connect_bd_intf_net -intf_net axi_hpm0_fpd_M03_AXI [get_bd_intf_pins axi_hpm0_fpd/M03_AXI] [get_bd_intf_pins real_bWeights/S_AXI]
  ...
  connect_bd_net -net Net3 [get_bd_pins real_bWeights/gpio_io_o] [get_bd_pins xlslice_real_00/Din] [get_bd_pins xlslice_real_01/Din] [get_bd_pins xlslice_real_20/Din] [get_bd_pins xlslice_real_21/Din]
  connect_bd_net -net Net4 [get_bd_pins imag_bWeights/gpio_io_o] [get_bd_pins xlslice_imag_00/Din] [get_bd_pins xlslice_imag_01/Din] [get_bd_pins xlslice_imag_20/Din] [get_bd_pins xlslice_imag_21/Din]
  ...
  connect_bd_net -net bWeight_imag_00_1 [get_bd_pins radio/bWeight_imag_00] [get_bd_pins xlslice_imag_00/Dout]
  connect_bd_net -net bWeight_imag_01_1 [get_bd_pins radio/bWeight_imag_01] [get_bd_pins xlslice_imag_01/Dout]
  connect_bd_net -net bWeight_imag_20_1 [get_bd_pins radio/bWeight_imag_20] [get_bd_pins xlslice_imag_20/Dout]
  connect_bd_net -net bWeight_imag_21_1 [get_bd_pins radio/bWeight_imag_21] [get_bd_pins xlslice_imag_21/Dout]
  connect_bd_net -net bWeight_real_00_1 [get_bd_pins radio/bWeight_real_00] [get_bd_pins xlslice_real_00/Dout]
  connect_bd_net -net bWeight_real_01_1 [get_bd_pins radio/bWeight_real_01] [get_bd_pins xlslice_real_01/Dout]
  connect_bd_net -net bWeight_real_20_1 [get_bd_pins radio/bWeight_real_20] [get_bd_pins xlslice_real_20/Dout]
  connect_bd_net -net bWeight_real_21_1 [get_bd_pins radio/bWeight_real_21] [get_bd_pins xlslice_real_21/Dout]
  ...
  connect_bd_net -net rst_ps8_0_99M_peripheral_aresetn [get_bd_pins CMAC/ARESETN] [get_bd_pins axi_hpm0_fpd/M01_ARESETN] [get_bd_pins axi_hpm0_fpd/M02_ARESETN] [get_bd_pins axi_hpm0_fpd/M03_ARESETN] [get_bd_pins axi_hpm0_lpd/M00_ARESETN] [get_bd_pins axi_hpm0_lpd/M01_ARESETN] [get_bd_pins axi_hpm0_lpd/M02_ARESETN] [get_bd_pins axi_hpm0_lpd/M03_ARESETN] [get_bd_pins axi_hpm0_lpd/M04_ARESETN] [get_bd_pins axi_hpm0_lpd/M05_ARESETN] [get_bd_pins axi_hpm0_lpd/M06_ARESETN] [get_bd_pins axi_hpm0_lpd/M07_ARESETN] [get_bd_pins axi_hpm0_lpd/M08_ARESETN] [get_bd_pins axi_hpm0_lpd/S00_ARESETN] [get_bd_pins axi_hpm1_fpd/M00_ARESETN] [get_bd_pins axi_hpm1_fpd/M01_ARESETN] [get_bd_pins axi_hpm1_fpd/M02_ARESETN] [get_bd_pins axi_hpm1_fpd/S00_ARESETN] [get_bd_pins axi_intc_0/s_axi_aresetn] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins binary_latch_counter_0/resetn] [get_bd_pins btns_gpio/s_axi_aresetn] [get_bd_pins imag_bWeights/s_axi_aresetn] [get_bd_pins iop_pmod0/s_axi_aresetn] [get_bd_pins iop_pmod1/s_axi_aresetn] [get_bd_pins leds_gpio/s_axi_aresetn] [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins radio/s_axi_aresetn] [get_bd_pins real_bWeights/s_axi_aresetn] [get_bd_pins rgbleds_gpio/s_axi_aresetn] [get_bd_pins sws_gpio/s_axi_aresetn] [get_bd_pins system_management_wiz_0/s_axi_aresetn] [get_bd_pins syzygy_std0/s_axi_aresetn]
  ...
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins CMAC/ACLK] [get_bd_pins address_remap_0/m_axi_out_aclk] [get_bd_pins address_remap_0/s_axi_in_aclk] [get_bd_pins axi_hpm0_fpd/M01_ACLK] [get_bd_pins axi_hpm0_fpd/M02_ACLK] [get_bd_pins axi_hpm0_fpd/M03_ACLK] [get_bd_pins axi_hpm0_lpd/ACLK] [get_bd_pins axi_hpm0_lpd/M00_ACLK] [get_bd_pins axi_hpm0_lpd/M01_ACLK] [get_bd_pins axi_hpm0_lpd/M02_ACLK] [get_bd_pins axi_hpm0_lpd/M03_ACLK] [get_bd_pins axi_hpm0_lpd/M04_ACLK] [get_bd_pins axi_hpm0_lpd/M05_ACLK] [get_bd_pins axi_hpm0_lpd/M06_ACLK] [get_bd_pins axi_hpm0_lpd/M07_ACLK] [get_bd_pins axi_hpm0_lpd/M08_ACLK] [get_bd_pins axi_hpm0_lpd/S00_ACLK] [get_bd_pins axi_hpm1_fpd/ACLK] [get_bd_pins axi_hpm1_fpd/M00_ACLK] [get_bd_pins axi_hpm1_fpd/M01_ACLK] [get_bd_pins axi_hpm1_fpd/M02_ACLK] [get_bd_pins axi_hpm1_fpd/S00_ACLK] [get_bd_pins axi_intc_0/s_axi_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_0/S01_ACLK] [get_bd_pins binary_latch_counter_0/clk] [get_bd_pins btns_gpio/s_axi_aclk] [get_bd_pins ila_0/clk] [get_bd_pins imag_bWeights/s_axi_aclk] [get_bd_pins iop_pmod0/clk_100M] [get_bd_pins iop_pmod1/clk_100M] [get_bd_pins leds_gpio/s_axi_aclk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins radio/s_axi_aclk] [get_bd_pins real_bWeights/s_axi_aclk] [get_bd_pins rgbleds_gpio/s_axi_aclk] [get_bd_pins shutdown_lpd/clk] [get_bd_pins sws_gpio/s_axi_aclk] [get_bd_pins system_management_wiz_0/s_axi_aclk] [get_bd_pins syzygy_std0/s_axi_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_lpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm1_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins zynq_ultra_ps_e_0/saxi_lpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihp0_fpd_aclk]
  ...
  assign_bd_address -offset 0xA0020000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs imag_bWeights/S_AXI/Reg] -force
  assign_bd_address -offset 0xA0030000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs real_bWeights/S_AXI/Reg] -force
  ...
  exclude_bd_addr_seg -target_address_space [get_bd_addr_spaces CMAC/axi_dma/Data_MM2S] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_HIGH]
  ...
  exclude_bd_addr_seg -target_address_space [get_bd_addr_spaces CMAC/axi_dma/Data_S2MM] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_HIGH]
